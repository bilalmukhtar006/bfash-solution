...
import {
  ArrowRight, Globe, Search, ShoppingBag, Palette, Sparkles,
  CheckCircle2, Target, Headphones, Zap,
} from "lucide-react";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Stunning websites, branding, SEO and Amazon growth — everything you need to thrive online, all under one roof." },
      { property: "og:title", content: "BFash Solutions — Premium Digital Agency" },
      { property: "og:description", content: "Web design, SEO, Amazon growth & branding under one roof." },
    ],
  }),
  component: Home,
});
...
function Home() {
  return (
    <>
      ...
      <section className="relative pt-36 pb-24 md:pt-44 md:pb-32 overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-6 text-center animate-fade-up">
          ...
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-display font-bold tracking-tight leading-[1.05] mb-6">
            Your Vision. <span className="gradient-text">Our Digital Expertise.</span><br />
            Affordable SEO Agency
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed mb-10">
            As a premier affordable SEO agency, we build stunning websites, design unforgettable branding, 
            and dramatically optimize your search rankings to scale your business online. Discover everything 
            you need to thrive and dominate your market, all delivered seamlessly under one roof.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/contact">
              <Button size="lg" variant="outline" className="border-border bg-surface/40 hover:bg-surface px-8 h-12">
                Let's Talk
              </Button>
            </Link>
          </div>
      ...
      {/* INTRO */}
      <Section eyebrow="Who We Are" title="A full-service digital partner built for ambitious brands" center>
        <p className="text-lg text-muted-foreground leading-relaxed text-center max-w-4xl mx-auto">
          ...
          helping brands stand out, scale up, and dominate their market. Whether you are a 
          brand-new startup looking for a killer logo and web presence, an established 
          business aiming for page one of Google, or an e-commerce seller wanting to skyrocket 
          your Amazon sales — we have the tailored strategy and digital marketing skills to make it happen.
        </p>
      </Section>
      ...
      <Section eyebrow="Why BFash" title="Why Partner with BFash Solutions?" center>
        <div className="grid md:grid-cols-3 gap-6">
          {values.map((v, i) => (
            <div key={v.title} className="glass-card rounded-2xl p-8 animate-fade-up" style={{ animationDelay: `${i * 0.1}s` }}>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">
              Let's discuss how we can scale your digital presence. Drop us a message for a free consultation.
            </p>
            <ul className="space-y-3">
              {["No-pressure discovery call", "Custom roadmap delivered in 48h", "Transparent pricing"].map((p) => (
