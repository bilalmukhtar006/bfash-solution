        ...
        <div className="mx-auto max-w-4xl">
          <article className="prose prose-invert max-w-none">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-4">
              ...
              that helps businesses promote their products or services online through SEO,
              social media, paid advertising, content marketing, and other digital channels.
            </p>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-4">
              A digital marketing agency follows a structured process: discovery &amp; research,
              strategy development, execution &amp; implementation, and measurement &amp; optimization.
            </p>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-4">
              ...
              creating a portfolio, setting up your business, and finding your first clients.
            </p>

            <h2 className="text-3xl font-display font-bold text-white mt-12 mb-4">
              4. SEO vs. AEO vs. GEO: What's the Difference in 2026?
            </h2>
            <p className="text-lg text-muted-foreground leading-relaxed mb-4">
