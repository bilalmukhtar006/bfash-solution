...
export function Section({
  ...
  children?: ReactNode; className?: string; center?: boolean;
}) {
  return (
      ...
      <div className="mx-auto max-w-7xl px-6">
        {(eyebrow || title || subtitle) && (
          <div className={`mb-12 md:mb-16 ${center ? "text-center mx-auto max-w-3xl" : "max-w-3xl"}`}>
            ...
            {title && <h2 className="text-3xl md:text-5xl font-display font-bold tracking-tight mb-4">{title}</h2>}
  ...
  return (
    <section className="pt-36 pb-16 md:pt-44 md:pb-24 relative overflow-hidden">
      <div className="absolute inset-0 -z-10 opacity-40">
        ...
        <div className="absolute top-32 right-1/4 h-72 w-72 rounded-full bg-brand-strong/30 blur-3xl animate-float" style={{ animationDelay: "2s" }} />
      </div>
